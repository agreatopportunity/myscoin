...
"Copyright &copy; 2017 Funcoin Developer"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Myscoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Myscoin</b> version", 0));
